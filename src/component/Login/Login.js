...
const Login = () => {
  ...
  return (
    <div className="flex justify-center">
      <div className="grid items-center shadow-sm-light bg-gray-600 m-8 w-80 h-96">
      <form onSubmit={handelInputFrom} className="m-5 ">
        ...
        <input
          ...
          name="password"
          className="bg-gray-50 mb-5 border border-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          required=""
        />
        <div className="flex justify-center">
        <button
